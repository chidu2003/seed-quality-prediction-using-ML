...
data, labels = getData()
train_data, test_data, train_labels, test_labels = model_selection.train_test_split(data, labels, test_size=0.30)

train_data, val_data, train_labels, val_labels = model_selection.train_test_split(train_data, train_labels,test_size=0.30)
...
history = model.fit(train_data, train_labels, epochs=70, validation_data=(val_data, val_labels)
                    )
